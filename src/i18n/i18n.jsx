...
const translations = {
  ...
  pl: {
    ...
    contact: {
      ...
      enterEmail: "Proszę wpisać swój e-mail",
      enterPhone: "Proszę wpisać swój numer telefonu",
      enterMessage: "Proszę wpisać swoją wiadomość",
  ...
  uk: {
    ...
    contact: {
      ...
      enterMessage: "Будь ласка, введіть ваше повідомлення",
