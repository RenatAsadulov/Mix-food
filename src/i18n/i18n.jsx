...
const translations = {
  ...
  pl: {
    ...
    contact: {
      ...
      enterName: "Imię",
      enterEmail: "E-mail",
      enterPhone: "Numer telefonu",
      enterMessage: "Wiadomość",
      errorMessage: "Coś poszło nie tak. Proszę spróbować ponownie.",
      cancel: "Anuluj",
  ...
  uk: {
    ...
    sections: {
      company: {
        title: "Про компанію",
        text: "МіксФуд — українська компанія, що спеціалізується на постачанні харчових ароматизаторів, барвників та стабілізаторів. Ми працюємо виключно з B2B-клієнтами: виробниками продуктів харчування, HoReCa та приватними марками. Пропонуємо як готові рішення, так і допомогу у розробці продукту під ваш технологічний процес.",
      },
      expertise: {
    ...
    contact: {
      ...
      enterName: "Ім'я",
      enterEmail: "Електронна пошта",
      enterPhone: "Номер телефону",
      enterMessage: "Повідомлення",
    ...
    seo: {
      homeTitle: "МіксФуд — Ароматизатори, барвники та стабілізатори для харчової промисловості",
      homeDescription:
        "МіксФуд — B2B постачання харчових ароматизаторів, барвників та стабілізаторів в Україні. Офіційний представник JAR. Власне виробництво, лабораторія, адаптація рецептур під ваш технологічний процес.",
      newsTitle: "Новини | МіксФуд",
      newsDescription:
        "Новини від МіксФуд — постачальника харчових ароматизаторів та інгредієнтів для виробництва. Оновлення асортименту, партнерства та події.",
      contactTitle: "Контакти | МіксФуд",
      contactDescription:
        "Зв'яжіться з МіксФуд для замовлення ароматизаторів, барвників та стабілізаторів. Консультація технолога, тестові партії, швидка доставка по Україні.",
    },
    faq: {
      title: "Часті запитання",
      items: [
        {
          question: "Які продукти постачає МіксФуд?",
          answer: "МіксФуд постачає харчові ароматизатори, барвники та стабілізатори для підприємств харчової промисловості. Ми є офіційним представником польського бренду JAR та виробляємо власні ароматизатори.",
        },
        {
        ...
        {
          question: "Як замовити продукцію від МіксФуд?",
