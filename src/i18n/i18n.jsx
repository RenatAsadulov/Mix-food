...
const translations = {
  ...
  uk: {
    ...
    seo: {
      homeTitle: "МіксФуд — Ароматизатори, барвники та стабілізатори",
      homeDescription:
        "МіксФуд — B2B-постачальник харчових ароматизаторів, барвників і стабілізаторів. Офіційний представник JAR в Україні з власним виробництвом та лабораторією.",
      newsTitle: "Новини | МіксФуд",
      newsDescription:
        "Останні новини та оновлення від МіксФуд — постачальника харчових ароматизаторів.",
      contactTitle: "Контакти | МіксФуд",
      contactDescription:
        "Зв'яжіться з МіксФуд для замовлення ароматизаторів, екстрактів та харчових добавок.",
    },
    faq: {
